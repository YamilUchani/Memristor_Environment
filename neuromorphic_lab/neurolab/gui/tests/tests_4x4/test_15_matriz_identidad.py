"""
neurolab.gui.tests.tests_4x4.test_15_matriz_identidad
======================================================
Prueba 4x4_15: Matriz Identidad (Solo Diagonal Activa).
...
def draw_4x4_15(gui, **kwargs):
    """Programa la matriz como identidad y verifica que los valores cuadran analíticamente."""
    config = CrossbarConfig(n_rows=4, n_cols=4)
    cb = CrossbarIdeal(config)

    # Matriz identidad: diagonal fuerte, fondo mínimo
    G_diag = 500e-6   # 500 μS en diagonal
    ...
    # ✅ FIX: Voltajes explícitos y consistentes con la verificación analítica
    # I_j = G_diag·V_j + G_off·Σ_{i≠j} V_i
    # I₁ = 500·1.0 + 62·(0.8+0.6+0.4) = 500 + 111.6 = 611.6 μA
    # I₂ = 500·0.8 + 62·(1.0+0.6+0.4) = 400 + 124.0 = 524.0 μA
    # I₃ = 500·0.6 + 62·(1.0+0.8+0.4) = 300 + 136.4 = 436.4 μA
    # I₄ = 500·0.4 + 62·(1.0+0.8+0.6) = 200 + 148.8 = 348.8 μA
    ...
    ax1.set_title(f'Matriz Identidad G (μS)\n'
                  f'(G_diag={G_diag*1e6:.0f}, G_off={G_off*1e6:.0f})',
    ...
    ax2.set_title('Corrientes: I_j = G_jj·V_j + G_off·Σ V_i',
                  color=title_color, fontsize=11, fontweight='bold')
    ...
    fig.suptitle('Prueba 4×4_15: Operación con Matriz Identidad',
